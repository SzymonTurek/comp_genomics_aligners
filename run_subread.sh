...
docker run --platform linux/amd64 -it --rm -v $(pwd):/data nanozoo/subread:2.0.2--53f5da6 subread-align -T 3 -t 1 -d 50 -D 600 -i /data/drosophila_subread_index/drosophila_index -r /data/bfc_corrected_trimmomatic_SRR6008629_1.fastq.gz -R /data/bfc_corrected_trimmomatic_SRR6008629_2.fastq.gz -o /data/subread_SRR6008629_PE.bam
